...
// Part 1: Add new article from form
...
articlesWrapper.addEventListener('click', function (event) {
  ...
  // Part 2: Delete article
  if (target.classList.contains('delete-btn')) {
    const articleElement = target.closest('.article-container');
  ...
  // Part 3: Read More / Read Less
  if (target.classList.contains('btn')) {
    const paragraph = target.previousElementSibling;
